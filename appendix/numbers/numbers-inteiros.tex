...
\begin{proof}
    ...
    \[
        f(x+y)=f([(n+n', m+m')]_{\sim_Z})=u(n+n')-u(m+m')=(u(n)+u(n'))-(u(m)+u(m'))=(u(n)-u(m))+(u(n')-u(m'))=f(x)+f(y).
    \]
    $f$ preserva o produto: dados $x=[(n, m)]_{\sim_Z}$ e $y=[(n', m')]_{\sim_Z}$, temos que:
    \[
        f(x\cdot y)=f([(n\cdot n'+m\cdot m', n\cdot m'+m\cdot n')]_{\sim_Z})=u(n\cdot n'+m\cdot m')-u(n\cdot m'+m\cdot n')=(u(n)u(n')+u(m)u(m'))-(u(n)u(m')+u(m)u(n'))=(u(n)-u(m))(u(n')-u(m'))=f(x)f(y).
    \]
