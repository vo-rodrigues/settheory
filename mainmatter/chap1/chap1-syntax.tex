...
Conforme será discutido, é necessário cautela ao se substituir variáveis por termos que contém variáveis.
Por exemplo, a fórmula $\exists y \, (x \neq y)$ é verdadeira em diversas teorias, conforme será exemplificado, mas, ao substituir $x$ por $y$, obtemos $\exists y \, (y \neq y)$, falsa em qualquer teoria, conforme será discutido na próxima seção.

Optaremos por definir a substituição formal em fórmulas sem se preocupar com este problema, e, a seguir, definir a noção de \emph{substituição válida}.
