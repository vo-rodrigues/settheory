...
\begin{metadefinition}[Variáveis ligadas e livres]\index{variável!ligada}\index{variável!livre}\index{sentença}
...
\begin{metadefinition}[Fecho universal]\index{fecho universal}
...
\begin{metadefinition}[Substituição em termos]\index{substituição!em termos}
...
\begin{metadefinition}[Substituição em fórmulas]\index{substituição!em fórmulas}
    Seja $\mathcal L$ um léxico para uma linguagem de primeira ordem, $x$ uma variável e $t$ um termo.
...
\begin{metadefinition}\index{substituição!válida}\index{substituível}
    Seja $\mathcal L$ um léxico para uma linguagem de primeira ordem, $x$ uma variável e $t$ um termo.
