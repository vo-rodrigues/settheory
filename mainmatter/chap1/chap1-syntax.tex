...
Ainda não apresentamos uma noção de verdade ou de dedução, mas, utilizando do conhecimento prévio do leitor, podemos justificar a Metadefinição~\ref{mdef:substituibilidade} com exemplos.
