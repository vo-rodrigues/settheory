...
\begin{proof}
    ...
    Nesse caso, como uma ocorrência livre de $x$ em $\psi$ produziria uma ocorrência livre de $y$ em $\psi[x/t]$ caso $y$ ocorresse em $t$, concluímos que ou $x$ não ocorre livre em $\psi$, ou $y$ não ocorre em $t$.
