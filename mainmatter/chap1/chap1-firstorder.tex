...
Em uma linguagem expandida, tais símbolos podem ser usados para abreviar fórmulas fechadas específicas, desde que essa abreviação seja explicitamente fixada.
...
\begin{example}\label{exa:formulasPrimeiraOrdem}Utilizando a notação do Exemplo~\ref{exa:exemplosLexicos}, temos as seguintes fórmulas.
    \begin{itemize}
        ...
        \item No léxico da teoria dos grupos, $\exists e {=} e {\cdot} e e$ não é uma fórmula, pois $e$ é um símbolo de constante, e não uma variável, e a única forma de uma fórmula iniciada por $\exists$ ser uma fórmula é pela regra (vi).
...
\begin{exercise}\label{exr:subexpressoesDeFormula}
    ...
    Mostre que uma subexpressão de $\varphi$ é uma fórmula se, e somente se, ela é o escopo de uma ocorrência de um conectivo lógico, de um quantificador, do símbolo de igualdade, ou de um símbolo de predicado, incluindo o caso de predicados de aridade $0$.
\end{exercise}
