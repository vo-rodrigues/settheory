...
\begin{metadefinition}\label{mdef:lexicoPrimeiraOrdem}\index{léxico!de primeira ordem}\index{símbolo não lógico}\index{símbolo de predicado}\index{símbolo funcional}
