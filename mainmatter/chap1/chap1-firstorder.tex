...
\begin{metadefinition}\label{def:simbolos-logicos}\index{símbolo lógico}\index{conectivo lógico}\index{quantificador}
...
\begin{metadefinition}\index{léxico!de primeira ordem}\index{símbolo não lógico}\index{símbolo de predicado}\index{símbolo funcional}
    ...
    Juntamente com os símbolos lógicos da Metadefinição~\ref{def:simbolos-logicos}, eles constituem o léxico total da linguagem.
\end{metadefinition}
...
\begin{metadefinition}\index{termo}\index{constante}
...
\begin{metadefinition}\index{fórmula}\index{fórmula!atômica}\index{fórmula!equacional}\index{subfórmula}
...
\begin{convention}Utilizaremos as seguintes convenções de escrita.
    Escreveremos:
\begin{itemize}
