...
\begin{metadefinition}[Axiomas Lógicos]\label{mdef:axiomasLogicos}\index{axioma!lógico}
    ...
    \begin{enumerate}
        \item $A\rightarrow (B \rightarrow A)$.\label{ax:implicacao1}
        \item $(A \rightarrow (B \rightarrow C)) \rightarrow ((A \rightarrow B) \rightarrow (A \rightarrow C))$.\label{ax:implicacao2}
        ...
        \item $A \rightarrow (A \vee B)$. \label{ax:disjuncao1}
        \item $B \rightarrow (A \vee B)$. \label{ax:disjuncao2}
        \item $(A \rightarrow C) \rightarrow ((B \rightarrow C) \rightarrow ((A \vee B) \rightarrow C))$. \label{ax:disjuncao3}
        \item $(\neg A\rightarrow B) \rightarrow ((\neg A \rightarrow \neg B) \rightarrow A)$.\label{ax:negacao}
        \item $(A\leftrightarrow B) \rightarrow (A\rightarrow B)$.
        \item $(A\leftrightarrow B) \rightarrow (B\rightarrow A)$.
