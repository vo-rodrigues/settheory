...
\begin{metadefinition}\label{mdef:axiomasLogicos}\index{axioma lógico}
    ...
    \begin{enumerate}
        ...
        \item $x_1=y_1 \wedge \dots \wedge x_n=y_n \rightarrow f(x_1, \dots, x_n) = f(y_1, \dots, y_n)$, sempre que $f$ é um símbolo de função de aridade $n>0$.
        \item $x_1=y_1 \wedge \dots \wedge x_n=y_n \rightarrow R(x_1, \dots, x_n) \leftrightarrow R(y_1, \dots, y_n)$, sempre que $R$ é um símbolo de relação de aridade $n>0$.
    \end{enumerate}
\end{metadefinition}
...
Na prática, raramente, em matemática, escrevemos uma demonstração tão formal quanto a Metadefinição~\ref{mdef:demonstracaoFormal} exige.
...
\begin{metalemma}\label{mlem:modusPonens}
...
\begin{metalemma}\label{mlem:extensaoDeLinguagem}
...
\end{metalemma}
\begin{proof}
    Ver Exercício~\ref{exr:extensaoDeLinguagem}.
\end{proof}
...
\end{proof}
\section*{Exercícios}
\begin{exercise}\label{exr:extensaoDeLinguagem}
    Prove o Metalema~\ref{mlem:extensaoDeLinguagem}.
\end{exercise}
