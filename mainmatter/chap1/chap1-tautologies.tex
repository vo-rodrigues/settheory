...
Um dos caminhos para fazê-lo é o de, primeiro, trabalhar a noção de tautologia.
...
Por vezes, em vez de $P_1, P_2, \dots$, utilizaremos letras como $A$, $B$, $C$ para denotar variáveis proposicionais.
...
Manteremos a convenção de, salvo necessidade, utilizar a notação usual (infixa) em vez da notação polonesa, usando parênteses para eliminar ambiguidades quando necessário.
