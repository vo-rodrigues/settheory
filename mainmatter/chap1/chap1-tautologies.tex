...
\begin{metadefinition}[Fórmulas proposicionais]\index{fórmula proposicional}
...
\begin{metadefinition}[Valoração]\index{contradição}\index{tabela-verdade}
...
\begin{metadefinition}[Instância de tautologia]\index{instância de tautologia}
    Seja $\mathcal L$ um léxico para uma linguagem de primeira ordem.
