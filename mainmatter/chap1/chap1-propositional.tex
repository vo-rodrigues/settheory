...
\begin{proof}
    ...
    Então, pela Proposição~\ref{metaprop:PCmonotonicidade}, $\Gamma \cup \{\phi\} \vdash_P \phi \rightarrow \psi$.
    ...
    Então $\Gamma \vdash_P \phi \rightarrow \phi$ pela Proposição~\ref{metaprop:PCreflexividade}.
...
\begin{proof}
    ...
    \[
        ...
        \neg\neg \phi \rightarrow \neg\neg \psi.
    \]
    Pela Proposição~\ref{prop:PC13reciproca} e modus ponens,
    \[
        \{\neg \psi \rightarrow \neg \phi, \phi\}\vdash_P \neg\neg\phi.
    \]
    Logo,
