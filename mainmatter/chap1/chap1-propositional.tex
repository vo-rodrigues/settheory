...
Assim, expressões como deverão ser parentesadas sempre que forem utilizadas.
Após provarmos que a validade lógica de tais fórmulas repeita as leis associativas, poderemos omitir tais parenteses.
...
\begin{metatheorem}[Teorema das tautologias]\label{thm:tautologiasSaoTeoremas}
    ...
    \]
\end{metatheorem}
A estratégia da prova é começar com atribuições completas de valores de verdade, caso em que o Metalema~\ref{mlem:fundamentalValoracoes} se aplica diretamente, e então remover as hipóteses uma a partir de quebras de casos.
\begin{proof}
