...
\begin{metaproposition}[Quantificadores e implicações]\label{mprop:quantificadoresImplicacao}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \[
        \frac{\varphi\rightarrow\psi}
             {\exists x\varphi\rightarrow\exists x\psi}
        \]
        ...
        \frac{\varphi\leftrightarrow\psi}
             {\forall x\varphi\leftrightarrow\forall x\psi}
        \]
...
\begin{proof}
    ...
    Como $x$ não ocorre livre em $\psi\rightarrow\forall x\psi$, pela regra de introdução do quantificador universal, $T\vdash \forall x\varphi\rightarrow\forall x\psi$.

    (ii) Por FO15, aplicado à fórmula $\varphi$ e ao termo $x$, temos $T\vdash \exists x\varphi\rightarrow\varphi$.
    Como $x$ não ocorre livre em $\exists x\varphi\rightarrow\varphi$, pela regra de introdução do quantificador existencial, $T\vdash \exists x\varphi\rightarrow\exists x\psi$.
