...
\begin{metaproposition}[Negação de quantificadores]\label{mprop:negacaoQuantificadores2}
...
\end{metaproposition}
\begin{proof}
    (i) Por FO14, como a substituição de $x$ por $x$ é sempre válida, temos $T\vdash \forall x\varphi\rightarrow\psi$.
    ...
    (ii) Por FO15, como a substituição de $x$ por $x$ é sempre válida, temos $T\vdash \varphi\rightarrow\exists x\psi$.
