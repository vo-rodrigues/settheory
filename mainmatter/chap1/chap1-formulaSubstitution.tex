...
\begin{metatheorem}\label{mthm:substituicaoFormulasEquivalentes}
    ...
    Considere, na linguagem $\mathcal L_P$, letras proposicionais distintas $A_1,\dots,A_n$ e uma $\mathcal L_P$-fórmula $\theta$ sem igualdade cujas únicas letras proposicionais estão dentre $A_1,\dots,A_n$.
...
\begin{proof}
    ...
    \]
    Pela preservação dos conectivos por equivalências,
    \[
        T\vdash
...
\begin{example}
    ...
    \]
    Aplicando o metateorema ao esqueleto
    \[
...
\begin{example}
    ...
    \[
        T\vdash \varphi(z)\leftrightarrow\psi(z).
    \]
    Podemos substituir apenas uma das ocorrências de $\varphi(z)$ em uma fórmula onde ela aparece mais de uma vez.
