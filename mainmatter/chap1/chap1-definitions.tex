...
\begin{metalemma}[Independência do auxiliar em $\exists!$]\label{mlem:independenciaAuxiliarExistsUnique}
    ...
    \begin{equation}
        (\exists x\,\varphi)\ \wedge\ \forall x\,\forall z\bigl((\varphi \wedge \varphi[x/z])\rightarrow x=z\bigr),
    \end{equation}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        Nos axiomas sobre igualdade, se o símbolo envolvido é novo, usa-se ainda que a fórmula definidora é uma $\mathcal L$-fórmula, a Lei da igualdade de Leibniz e, no caso de símbolos funcionais, a hipótese de unicidade exigida na Metadefinição~\ref{mdef:definicaoExplicita}.
