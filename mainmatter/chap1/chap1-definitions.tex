...
\begin{metadefinition}[Fórmula do valor de um termo]\label{mdef:formulaDoValorDeUmTermo}\index{termo!fórmula do valor}\index{eliminação de símbolos definidos!termos}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \]
        em que $x_1, \dots, x_n$ são variáveis que ocorrem em $t$ (e elas incluem as de $t_1, \dots, t_m$), $y_1, \dots, y_m$ são as variáveis auxiliares introduzidas para descrever os termos $t_1, \dots, t_m$ (alteradas para serem distintas de $x_1, \dots, x_n$, se necessário), e $y$ é distinta de todas as outras.
    \end{enumerate}
\end{metadefinition}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        A verificação é sistemática: usa-se que $\ast$ comuta com conectivos e quantificadores e que termos são eliminados pelo
