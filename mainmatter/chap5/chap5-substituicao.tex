...
\begin{axiom}[Esquema de axiomas da substituição]\index{Esquema de Axiomas da Substituição}
...
\begin{theorem}\index{tipo de uma boa ordem}
...
\begin{definition}\index{tipo de uma boa ordem}
