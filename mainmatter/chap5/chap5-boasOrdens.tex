...
\begin{definition}[$Z^--P$]\label{def:segmentoInicial}\index{segmento inicial}
...
\begin{lemma}[$Z^-$]\label{lem:funcaoCrescenteAcimaDaIdentidade}
...
\begin{lemma}[$Z^-$]\label{lem:isomorfismoParaSegmentoInicialEhIdentidade}
...
\begin{corollary}[$Z^-$]\label{cor:unicidadeDoIsomorfismoDeBoasOrdens}
...
\begin{definition}[$Z^--P$]\label{def:segmentoInicialDeterminadoPorElemento}
    Seja $A$ uma boa ordem e $a\in A$.
    Definimos $A[a] = \{x\in A : x<a\}$.
\end{definition}
\begin{lemma}[$Z^--P$]\label{lem:segmentosIniciaisPropriosSaoDeterminadosPorElementos}
    Seja $A$ uma boa ordem e $a\in A$.
...
\begin{lemma}[$Z^--P$]\label{lem:isomorfismoPreservaSegmentosIniciais}
...
\begin{lemma}[$Z^--P$]\label{lem:segmentosIniciaisDeSegmentosIniciais}
...
\begin{theorem}[$Z^-$]\label{thm:comparacaoDeBoasOrdens}\index{teorema!de comparação de boas ordens}
    Sejam $A$ e $B$ boas ordens.
...
\begin{exercise}[$Z^-$]
    ...
    \]
\end{exercise}
\begin{exercise}[$Z^-$]\label{exr:uniaoDeBoasOrdens}
