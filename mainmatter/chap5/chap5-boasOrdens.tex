...
\begin{definition}\label{def:segmentoInicial}\index{segmento inicial}
...
\begin{lemma}\label{lem:funcaoCrescenteAcimaDaIdentidade}
...
\begin{lemma}\label{lem:isomorfismoParaSegmentoInicialEhIdentidade}
...
\begin{corollary}\label{cor:unicidadeDoIsomorfismoDeBoasOrdens}
...
\begin{definition}\label{def:segmentoInicialDeterminadoPorElemento}
    Seja $A$ uma boa ordem e $a\in A$.
    Definimos $A[a] = \{x\in A : x<a\}$.
\end{definition}
\begin{lemma}\label{lem:segmentosIniciaisPropriosSaoDeterminadosPorElementos}
    Seja $A$ uma boa ordem e $a\in A$.
...
\begin{lemma}\label{lem:isomorfismoPreservaSegmentosIniciais}
...
\begin{lemma}\label{lem:segmentosIniciaisDeSegmentosIniciais}
...
\begin{theorem}\label{thm:comparacaoDeBoasOrdens}\index{teorema de comparação de boas ordens}
    Sejam $A$ e $B$ boas ordens.
...
\begin{exercise}
    ...
    \]
\end{exercise}
\begin{exercise}\label{exr:uniaoDeBoasOrdens}
