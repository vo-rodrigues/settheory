...
\begin{definition}\label{def:conjuntoTransitivo}\index{conjunto transitivo}
    Um conjunto $A$ é dito \emph{transitivo} se, para todo $a\in A$, $a\subseteq A$.
\end{definition}

Agora podemos definir um ordinal.

\begin{definition}\label{def:ordinal}\index{ordinal}
...
\begin{example}\label{exa:omegaEhOrdinal}
...
\begin{lemma}\label{lem:elementosDeOrdinalSaoOrdinais}
...
\begin{lemma}\label{lem:intersecaoNaoVaziaDeOrdinaisEhOrdinal}
...
\begin{lemma}\label{lem:inclusaoDeOrdinaisEquivPertencimentoOuIgualdade}
...
\end{proof}
\begin{proposition}\label{prop:estruturaBasicaDosOrdinais}
...
\begin{corollary}\label{cor:conjuntoTransitivoDeOrdinaisEhOrdinal}
Todo conjunto de ordinais é bem-ordenado por $\in$.
Assim, um conjunto de ordinais transitivo é um ordinal.
\end{corollary}
\begin{corollary}\label{cor:naoExisteConjuntoDeTodosOrdinais}
...
\begin{proposition}\label{prop:sucessorDeOrdinalEhOrdinal}
    Seja $\alpha$ um ordinal.
...
\begin{lemma}\label{lem:uniaoDeOrdinaisEhSupremo}\index{supremo!de ordinais}
...
\begin{proposition}\label{prop:omegaEhOrdinalLimite}
...
\begin{proposition}\label{prop:ordinaisNaoSaoIsomorfos}
...
\begin{exercise}
    ...
    \]
\end{exercise}
\begin{exercise}\label{exr:segmentoInicialDeOrdinal}
