...
\begin{definition}[$Z^--P$]\label{def:conjuntoTransitivo}\index{conjunto transitivo}
    Um conjunto $A$ é dito \emph{transitivo} se, para todo $a\in A$, $a\subseteq A$.
\end{definition}

Agora podemos definir um ordinal.

\begin{definition}[$Z^--P$]\label{def:ordinal}\index{ordinal}
...
\begin{example}[$Z^--P$]\label{exa:omegaEhOrdinal}
...
\begin{lemma}[$Z^--P$]\label{lem:elementosDeOrdinalSaoOrdinais}
...
\begin{lemma}[$Z^--P$]\label{lem:intersecaoNaoVaziaDeOrdinaisEhOrdinal}
...
\begin{lemma}[$Z^--P$]\label{lem:inclusaoDeOrdinaisEquivPertencimentoOuIgualdade}
...
\end{proof}
\begin{proposition}[$Z^--P$]\label{prop:estruturaBasicaDosOrdinais}
...
\begin{corollary}[$Z^--P$]\label{cor:conjuntoTransitivoDeOrdinaisEhOrdinal}
Todo conjunto de ordinais é bem-ordenado por $\in$.
Assim, um conjunto de ordinais transitivo é um ordinal.
\end{corollary}
\begin{corollary}[$Z^--P$]\label{cor:naoExisteConjuntoDeTodosOrdinais}
...
\begin{proposition}[$Z^--P$]\label{prop:sucessorDeOrdinalEhOrdinal}
    Seja $\alpha$ um ordinal.
...
\begin{lemma}[$Z^--P$]\label{lem:uniaoDeOrdinaisEhSupremo}\index{supremo!de ordinais}
...
\begin{definition}\label{def:ordinaisSucessoresELimites}\index{ordinal!sucessor}\index{ordinal!limite}
...
\begin{proposition}[$Z^--P$]\label{prop:omegaEhOrdinalLimite}
...
\begin{proposition}[$Z^-$]\label{prop:ordinaisNaoSaoIsomorfos}
...
\begin{exercise}[$Z^--P$]
    ...
    \]
\end{exercise}
\begin{exercise}[$Z^--P$]\label{exr:segmentoInicialDeOrdinal}
