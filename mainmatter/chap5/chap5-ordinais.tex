...
\begin{lemma}\index{supremo!de ordinais}
...
\begin{definition}\index{ordinal!sucessor}\index{ordinal!limite}
...
\begin{exercise}
    ...
    \]
\end{exercise}
\begin{exercise}\label{ex:segmentoInicialOrdinal}
