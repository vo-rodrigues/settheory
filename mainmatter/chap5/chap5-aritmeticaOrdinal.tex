...
\begin{definition}\label{def:soma-ordinal}\index{soma ordinal}
...
\begin{proposition}\index{subtração ordinal}
...
\begin{definition}\index{produto ordinal}
...
\begin{definition}\index{exponenciação ordinal}
