\section{Aritmética ordinal}\label{sec:aritmeticaOrdinal}
\index{aritmética ordinal}
\index{soma ordinal}
\index{produto ordinal}
\index{exponenciação ordinal}
Nesta seção, definiremos soma, produto e exponenciação de ordinais.

O Exemplo~\ref{exa:somaOrdinal} justifica a definição de soma ordinal abaixo.
\begin{definition}\label{def:somaOrdinal}\index{soma ordinal}
...
\begin{example}\label{exa:somaOrdinalNaoComutativa}
...
\begin{lemma}\label{lem:somaOrdinalMajorizaSegundoTermo}
...
\begin{lemma}\label{lem:somaOrdinalEstritamenteCrescenteNoSegundoArgumento}
...
\begin{proposition}\label{prop:subtracaoOrdinal}\index{subtração ordinal}
...
\begin{proposition}\label{prop:tipoLexicograficoDaSomaOrdinal}
...
\begin{definition}\label{def:produtoOrdinal}\index{produto ordinal}
    ...
    \[
        ...
        \end{cases}
    \]
    O Metateorema~\ref{mthm:esquemaDaRecursaoTransfinita} nos dá, então, uma receita para introduzir por definição $F(\beta, \alpha)=\beta\cdot \alpha$ tal que:
    \begin{itemize}
...
\begin{definition}\label{def:exponenciacaoOrdinal}\index{exponenciação ordinal}
    ...
    \[
        ...
        \begin{cases}
            ...
            \end{cases}
        \]
    O Metateorema~\ref{mthm:esquemaDaRecursaoTransfinita} nos dá, então, uma receita para introduzir por definição $F(\beta, \alpha)=\beta^\alpha$ tal que:
    \begin{itemize}
...
\section*{Exercícios}
\begin{exercise}
    Assuma que $+$ e $+'$ são duas operações introduzidas por definição que satisfazem as propriedades descritas na Definição~\ref{def:somaOrdinal}.
