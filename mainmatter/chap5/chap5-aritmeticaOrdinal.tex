...
\begin{exercise}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item Se $0<\beta\leq \alpha$, existe um maior ordinal $\xi$ tal que $\beta^\xi\leq \alpha$.
        \item (Forma Normal de Cantor) se $2\leq \beta$ e $1\leq \alpha$, existem únicos ordinais $n\geq 1$ e ordinais $\xi_1<\dots<\xi_n$ e ordinais $\gamma_1,\dots,\gamma_n$ com $1\leq \gamma_i<\beta$ para todo $i\leq n$ tais que
        \[
            \alpha=\beta^{\xi_n}\cdot \gamma_n+\dots+\beta^{\xi_1}\cdot \gamma_1.
        \]
        ...
        Para a unicidade, proceda novamente por indução em $\alpha$.
