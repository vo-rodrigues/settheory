...
Conforme vimos, se $n>0$ é um número natural, $n=\{0,1,\ldots,n-1\}$, ou, mais formalmente, $n=\{m\in\omega : m<n\}$.
...
\begin{corollary}Sobre finitude, temos o seguinte.
...
\begin{corollary}\label{cor:finitoBoaOrdem}
