...
\begin{definition}[$\BST$](Classe de equivalência)\label{def:classeDeEquivalencia}\index{classe de equivalência}\index{conjunto quociente}
    ...
    ($\ZmI$) O conjunto de todas as classes de equivalência de elementos de $A$ é denotado por $A/{\sim}$.
\end{definition}
...
\begin{proposition}[$\BST$]\label{prop:propriedadesBasicasDasClassesDeEquivalencia}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item ($\ZmI$) $\displaystyle A=\bigcup \Big(A/{\sim}\Big)$.
    \end{enumerate}
\end{proposition}
...
\begin{proposition}[$\ZmI$]\label{prop:particaoInduzRelacaoDeEquivalencia}
...
\begin{proposition}[$\ZFmI$]\label{prop:relacaoDeEquivalenciaInduzidaPelaParticao}
