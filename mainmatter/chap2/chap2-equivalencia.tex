...
\begin{definition}[$Z^{-}$](Relação de equivalência)\label{def:relacaoDeEquivalencia}\index{relação!de equivalência}
...
\begin{example}[$Z^{-}$]\label{exa:relacaoDeIgualdade}
    Seja $A$ um conjunto.
...
\begin{example}[$Z^{-}$]\label{exa:relacaoUniversal}
    Seja $A$ um conjunto.
...
\begin{example}[$Z^{-}$]\label{exa:relacaoDeEquivalenciaInduzidaPorFuncao}
...
\begin{definition}[$Z^{-}$](Classe de equivalência)\label{def:classeDeEquivalencia}\index{classe de equivalência}\index{conjunto quociente}
...
\begin{proposition}[$Z^{-}$]\label{prop:propriedadesBasicasDasClassesDeEquivalencia}
...
\begin{definition}[$Z^{-}$](Partição)\label{def:particao}\index{partição}
    Seja $A$ um conjunto.
...
Todos os exercícios desta seção devem ser resolvidos em $Z^{-}$.
