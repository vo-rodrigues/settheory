...
\begin{definition}[$Z^{-}-P$](Relação de equivalência)\label{def:relacaoDeEquivalencia}\index{relação!de equivalência}
...
\begin{definition}[$Z^{-}-P$](Classe de equivalência)\label{def:classeDeEquivalencia}\index{classe de equivalência}\index{conjunto quociente}
...
\begin{proposition}[$Z^{-}-P$]\label{prop:propriedadesBasicasDasClassesDeEquivalencia}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item ($Z^{-}$) $\displaystyle A=\bigcup A/{\sim}$.
    \end{enumerate}
\end{proposition}
...
\begin{definition}[$Z^{-}-P$](Partição)\label{def:particao}\index{partição}
    Seja $A$ um conjunto.
