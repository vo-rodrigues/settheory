...
\begin{definition}[Relação de equivalência]\label{def:relacaoDeEquivalencia}\index{relação de equivalência}
...
\begin{example}\label{exa:relacaoDeIgualdade}
    Seja $A$ um conjunto.
...
\begin{example}\label{exa:relacaoUniversal}
    Seja $A$ um conjunto.
...
\begin{example}\label{exa:relacaoDeEquivalenciaInduzidaPorFuncao}
...
\begin{definition}[Classe de equivalência]\label{def:classeDeEquivalencia}\index{classe de equivalência}\index{conjunto quociente}
...
\begin{proposition}\label{prop:propriedadesBasicasDasClassesDeEquivalencia}
...
\begin{definition}[Partição]\label{def:particao}\index{partição}
    Seja $A$ um conjunto.
...
\begin{proposition}\label{prop:particaoInduzRelacaoDeEquivalencia}
...
\begin{proposition}\label{prop:relacaoDeEquivalenciaInduzidaPelaParticao}
...
\begin{exercise}\label{exr:propriedadesBasicasDasClassesDeEquivalencia}
    Prove a Proposição~\ref{prop:propriedadesBasicasDasClassesDeEquivalencia}.
\end{exercise}
