...
Os axiomas serão introduzidos e estudados em detalhe ao longo dos capítulos inicias do texto.
...
\begin{displayaxiom}{Esquema de Axiomas da Compreensão}\index{axioma!esquema da compreensão}\index{axioma!esquema da separação}
...
\begin{displayaxiom}{Axioma da Regularidade (ou da Fundação)}\index{axioma!da regularidade}\index{axioma!da fundação}
    \[
...
\subsection{Nomenclatura}
    As letras $Z$ e $F$ em $ZF$ e $ZFC$ remete a Fraenkel.
