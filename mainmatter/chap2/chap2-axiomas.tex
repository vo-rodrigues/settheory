...
Em 1922, Fraenkel e, independentemente, Skolem observaram que a teoria de Zermelo era insuficiente para justificar certas construções por recursão transfinita e para o desenvolvimento adequado da teoria de ordinais e cardinais transfinitos.
...
Um ponto essencial na passagem da teoria original de Zermelo para as formulações modernas é a substituição da noção informal de ``propriedade definida'' por fórmulas da linguagem de primeira ordem da teoria dos conjuntos \cite{skolem1923bemerkungen}.
...
A reformulação de Zermelo de 1930 também teve papel importante na consolidação da perspectiva cumulativa da teoria dos conjuntos \cite{zermelo1930grenzzahlen,kanamori2004zermelo}.
...
A formulação acima é a versão por conjuntos de escolha, ou transversais, bastante próxima da forma usada por Zermelo em 1908 \cite{zermelo1908untersuchungen}.
No Capítulo~\ref{chap:axiomaDaEscolha}, veremos também formulações em termos de funções escolha.
...
\subsection{Nomenclatura}
    ...
    Em particular, o símbolo $Z$ não deve ser lido como uma reprodução literal da lista histórica de axiomas de Zermelo de 1908: aquela lista incluía o Axioma da Escolha e não continha o Axioma da Regularidade.
\begin{metadefinition}[Nomes das teorias]
    ...
    Este princípio isola o fechamento que será usado para construir produtos cartesianos e manipular relações elementares sem recorrer, neste ponto do texto, ao Axioma da Potência nem ao Esquema da Substituição.
    Sobre Extensão, Compreensão, Par e União, o Axioma dos Pares Internos é consequência tanto do Axioma da Potência quanto do Esquema da Substituição, sendo, neste contexto, equivalente à afirmação de que $A \times B$ existe para quaisquer conjuntos $A$ e $B$.

    É importante ressaltar que a sigla $\BST$ possui variações na literatura e está longe de ser universal.
    Em alguns tratamentos de teorias fracas de conjuntos, princípios próximos aparecem formulados diretamente como existência de produtos cartesianos.
    Estamos agrupando estes axiomas sob a sigla $\BST$ para fins didáticos e organizacionais compatíveis com a estrutura do restante deste texto.
\end{metadefinition}
