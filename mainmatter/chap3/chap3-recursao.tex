...
\begin{proof}
    ...
    Dado $p \in P$ e $n \in \omega$, seja $f_p=\bigcup\{t: t \text{ é uma computação parcial baseada em } G \text{ e } p\}$.

    Formalmente, acima estamos definindo $h:P\to\mathcal P([\omega\times A]^{<\omega})$ por
