...
\begin{proposition}\label{prop:existenciaDaAdicao}
...
\begin{definition}\label{def:adicao}\index{adição}
...
\begin{proposition}\label{prop:monotonicidadeEstritaDaAdicao}
...
\begin{proposition}\label{prop:existenciaDaDiferencaNosNaturais}
...
\begin{definition}\label{def:subtracaoNosNaturais}\index{subtração}
...
\begin{proposition}\label{prop:existenciaDaMultiplicacao}
...
\begin{definition}\label{def:multiplicacao}\index{multiplicação}
...
\begin{proposition}\label{prop:existenciaDaPotenciacao}
...
\begin{definition}\label{def:potenciacao}\index{potenciação}
