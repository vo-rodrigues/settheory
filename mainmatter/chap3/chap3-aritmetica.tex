...
\begin{definition}\index{subtração}
...
\begin{definition}\index{multiplicação}
...
\begin{definition}\index{potenciação}
...
\begin{exercise}\label{ex:recursionComposition}
