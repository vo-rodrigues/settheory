...
\begin{definition}[$Z^--P$]\label{def:equipotencia}\index{equipotência}
    Sejam $A$, $B$ conjuntos.
...
\begin{proposition}[$Z^-$]\label{prop:equipotenciaEquivalencia}
...
\begin{lemma}[$Z^--P$]\label{lem:naoExisteConjuntoDeSingletos}
...
\begin{definition}[$Z^--P$]\label{def:sucessor}\index{sucessor}
...
\begin{definition}[$Z^--P$]\label{def:conjuntoIndutivo}\index{conjunto indutivo}
...
\begin{definition}[$Z^--P$]\label{def:numerosNaturais}\index{conjunto dos números naturais}
...
\begin{lemma}[$Z^--P$]\label{lem:existenciaEUnicidadeDeOmega}
...
\begin{proposition}[$Z^--P$]\label{prop:omegaIndutivo}
...
\begin{proposition}[$Z^--P$]\label{prop:omegaEhUnicoSubconjuntoIndutivoDeSi}
...
\begin{proposition}[$Z^--P$](Esquema da Indução)\label{prop:esquemaDaInducaoNosNaturais}\index{indução}
...
\begin{definition}[$Z^--P$]\label{def:primeirosNaturais}
    \begin{align*}
        0 &= \emptyset,\\
        1 &= S(0) = \{0\},\\
        2 &= S(1) = \{0,1\},\\
...
\begin{proposition}[$Z^--P$]\label{prop:todoNaturalEhZeroOuSucessor}
