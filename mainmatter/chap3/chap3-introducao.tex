...
\begin{definition}\label{def:equipotencia}\index{equipotência}
    Sejam $A$, $B$ conjuntos.
...
\begin{proposition}\label{prop:equipotenciaEquivalencia}
...
\begin{lemma}\label{lem:naoExisteConjuntoDeSingletos}
...
\begin{definition}\label{def:sucessor}\index{sucessor}
...
\begin{definition}\label{def:conjuntoIndutivo}\index{conjunto indutivo}
...
\begin{axiom}\label{ax:infinito}\index{Axioma do Infinito}
...
\begin{definition}\label{def:numerosNaturais}\index{conjunto dos números naturais}
...
\begin{lemma}\label{lem:existenciaEUnicidadeDeOmega}
...
\begin{proposition}\label{prop:omegaEhIndutivo}
...
\begin{proposition}\label{prop:omegaEhUnicoSubconjuntoIndutivoDeSi}
...
\begin{proposition}\label{prop:esquemaDaInducaoNosNaturais}\index{indução}
...
\begin{definition}\label{def:primeirosNaturais}
    \begin{align*}
        0 &= \emptyset,\\
        1 &= S(0) = \{0\},\\
        2 &= S(1) = \{0,1\},\\
...
\begin{proposition}\label{prop:todoNaturalEhZeroOuSucessor}
