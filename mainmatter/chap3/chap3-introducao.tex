...
\begin{proposition}\label{prop:equipotencia-equivalencia}
...
\begin{definition}\index{sucessor}
...
\begin{definition}\index{conjunto indutivo}
...
\begin{axiom}\index{Axioma do Infinito}
...
\begin{definition}\index{conjunto dos números naturais}
...
\begin{proposition}\index{indução}
...
\begin{proposition}\label{prop:ordem-sucessor}
