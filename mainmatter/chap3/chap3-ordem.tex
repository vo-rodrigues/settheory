...
\begin{corollary}\index{boa ordem!dos números naturais}
...
\end{proposition}
\begin{proof}
    Já vimos que $\omega$ é uma boa ordem, e $\omega$ é não vazio pois $0 \in \omega$.
    ...
    Se $n\neq 0$, então $n=S(m)$ para algum $m \in \omega$.
    Como $n$ é o elemento mínimo de $B$, segue que $m \notin B$, ou seja, existe $k \in A$ tal que $k \not\leq m$.
    Assim, $m<k$, e, portanto, $n=S(m)\leq k$ pelo Lema~\ref{lem:ordem-menor-que-sucessor}.
