...
\begin{definition}\label{def:ordemDosNaturais}
    Sejam $m, n \in \omega$.
...
\begin{lemma}\label{lem:zeroMenorIgualATodoNatural}
...
\begin{lemma}\label{lem:menorQueSucessorEquivMenorIgual}
...
\begin{lemma}\label{lem:transitividadeDaOrdemNosNaturais}
...
\begin{lemma}\label{lem:irreflexividadeDaOrdemNosNaturais}
...
\begin{lemma}\label{lem:sucessorMenorIgualEquivMenorQue}
...
\begin{proposition}\label{prop:ordemTotalEstritaNosNaturais}
...
\begin{proposition}\label{prop:inducaoForteNosNaturais}
...
\begin{proposition}\label{prop:esquemaDaInducaoForte}
...
\begin{corollary}\label{cor:boaOrdemDosNaturais}\index{boa ordem!dos números naturais}
...
\begin{proposition}\label{prop:caracterizacaoBasicaDaOrdemNosNaturais}
